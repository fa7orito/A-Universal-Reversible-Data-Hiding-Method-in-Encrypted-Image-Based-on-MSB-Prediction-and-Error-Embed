...
if side_info_block_sec_error_flag == 0 && side_info_block_fin_error_flag == 0
    bits_available = bits_available-2-1;
elseif side_info_block_sec_error_flag == 1 && side_info_block_fin_error_flag == 0
    bits_available = bits_available-2-16-sum(sum(block_sec==2))-1;
elseif side_info_block_sec_error_flag == 0 && side_info_block_fin_error_flag == 1
    bits_available = bits_available-2-16-sum(sum(block_fin==2))-1;
else
    bits_available = bits_available-2-32-sum(sum(block_sec==2))-sum(sum(block_fin==2))-1;
end
